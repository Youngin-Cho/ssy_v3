...
def get_cfg():
    ...
    parser.add_argument("--save_every", type=int, default=10000, help="Save a model every x frames")
    parser.add_argument("--n_step", type=int, default=10, help="Multistep IQN")
    parser.add_argument("--capacity", type=int, default=10000, help="Replay memory size")
