...
def get_cfg():
    ...
    parser.add_argument("--num_critic_layers", type=int, default=2, help="number of critic(Q) layers")
    ...
    parser.add_argument("--tau", type=float, default=0.005, help="soft update ratio for target Q networks")
    parser.add_argument("--alpha_init", type=float, default=0.2, help="initial value of the entropy temperature")
    parser.add_argument("--target_entropy_ratio", type=float, default=0.98,
                        help="ratio used to set the target entropy relative to log(number of valid actions)")
